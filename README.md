...
###[nextfile](https://github.com/donmaiq/mpv-scripts/blob/master/nextfile.lua)  
  Force open next or previous file in the currently playing files directory. Toggle/message/set it to automatic on end of file if you'd like. Set filetypes inside settings variable in lua file.
